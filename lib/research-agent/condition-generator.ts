...
血統:
  ...
  - broodmare_sire: 母父名（例: "サンデーサイレンス"）
  - sire_type: 父タイプ（例: "スピード系", "スタミナ系"）
  - dam_type: 母タイプ

前走:
  - last_race_level: 前走レースレベル（例: "A+", "A", "B"）
  - last_finish_position: 前走着順（例: 1, 2, 3）
  - last_margin: 前走着差（例: 0.3秒）
  - last_popularity: 前走人気（例: 1, 2）

今回:
  - surface: 芝/ダート（例: "芝", "ダート"）
  - distance: 距離（例: 2000, [1800, 2200]）
  - place: 競馬場（例: "東京", "中山"）
  - waku: 枠番（例: 1, 2）
  - weight_carried: 斤量（例: 55）
