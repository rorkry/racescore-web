          ...
          <AnimatePresence mode="wait">
            ...
            <div className="racecard-card rounded-xl p-3 sm:p-6">
              ...
              <div className="table-scroll-container -mx-3 sm:mx-0 px-3 sm:px-0">
                <table className="table-fixed sm:table-auto w-full border-collapse">
                  <thead>
                      ...
                      return (
                        <React.Fragment key={horse.umaban}>
                          <tr className={`${index % 2 === 0 ? 'bg-white' : 'bg-slate-100'} text-xs sm:text-base hover:bg-emerald-50 transition-colors`}>
                            ...
                            {/* 騎手(斤量) */}
                            <td className="border border-slate-300 px-0.5 sm:px-3 py-2 text-slate-700 sm:whitespace-nowrap text-[10px] sm:text-sm text-center sm:text-left overflow-hidden">
                            ...
                            {/* 調教師 */}
                            <td className="border border-slate-300 px-1 sm:px-2 py-1.5 sm:py-2 text-slate-700 align-middle overflow-hidden sm:max-w-[9rem]">
                              <div
                          ...
                          {expandedHorse === horse.umaban && (
                            <tr key={`${horse.umaban}-detail`} className="relative z-[1]">
                              <td colSpan={6} className="border border-slate-300 bg-slate-50 min-w-0 align-top p-0 relative">
                                ...
                                */}
                                <div className="flex flex-col max-h-[min(72svh,36rem)] sm:max-h-[min(80svh,42rem)] min-h-0">
