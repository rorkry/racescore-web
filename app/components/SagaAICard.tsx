                  ...
                  {onHorseAction && (() => {
                    ...
                    return (
                      <button
                        ...
                        title={isFavorite ? 'お気に入り登録済み' : 'お気に入り・メモ'}
                      >
                        {isFavorite ? (
                          // 塗りつぶし星（登録済み）
                          ...
                          // アウトライン星（未登録）
                          <svg className="size-3.5 sm:size-4 text-yellow-400/60" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
